// ======================================================================
// shutter_controller_v2.v generated from TopDesign.cysch
// 12/19/2019 at 20:29
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=3, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=15535, CompareValue2=63, CONTROL3=0, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=1, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=65535, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=1, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=true, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=true, TriggerMode=1, UDB16=true, UDB8=false, UseControl=false, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=start_pulse, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=start_pulse, CY_INSTANCE_SHORT_NAME=start_pulse, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=start_pulse, )
module PWM_v3_30_0 (
    reset,
    clock,
    tc,
...
module top ;
	...
	wire [0:0] tmpOE__comp_in_net;
	wire [0:0] tmpIO_0__comp_in_net;
	wire [0:0] tmpINTERRUPT_0__comp_in_net;
	electrical [0:0] tmpSIOVREF__comp_in_net;
	...
	cy_psoc3_pins_v1_10
		...
		comp_in
		 (.oe(tmpOE__comp_in_net),
		  .y({1'b0}),
		  .fb({Net_360}),
		  .io({tmpIO_0__comp_in_net[0:0]}),
		  .siovref(tmpSIOVREF__comp_in_net),
		  .interrupt({tmpINTERRUPT_0__comp_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__comp_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PWM_v3_30_0 start_pulse (
        .reset(Net_161),
        .clock(Net_162),
        .tc(Net_161),
        .pwm1(Net_164),
        ...
        .ph1(Net_173),
        .ph2(Net_174));
    defparam start_pulse.Resolution = 16;
	...
	cy_psoc3_pins_v1_10
		#(.id("27290071-230e-495e-9987-64b5517aed38"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__open_ind_net;
	wire [0:0] tmpIO_0__open_ind_net;
	wire [0:0] tmpINTERRUPT_0__open_ind_net;
	electrical [0:0] tmpSIOVREF__open_ind_net;

	cy_psoc3_pins_v1_10
		#(.id("18a25035-b19a-4a9f-ab1a-db37126ba1be"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		open_ind
		 (.oe(tmpOE__open_ind_net),
		  .y({1'b0}),
		  .fb({Net_187}),
		  .io({tmpIO_0__open_ind_net[0:0]}),
		  .siovref(tmpSIOVREF__open_ind_net),
		  .interrupt({tmpINTERRUPT_0__open_ind_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__open_ind_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("95d07a2c-6996-472f-9ad3-097dd258fdfd"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__en_24_net;
	wire [0:0] tmpFB_0__en_24_net;
	wire [0:0] tmpIO_0__en_24_net;
	wire [0:0] tmpINTERRUPT_0__en_24_net;
	electrical [0:0] tmpSIOVREF__en_24_net;

	cy_psoc3_pins_v1_10
		#(.id("571522ba-13cb-4e0b-88c9-dc05ee09ddab"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		en_24
		 (.oe(tmpOE__en_24_net),
		  .y({Net_180}),
		  .fb({tmpFB_0__en_24_net[0:0]}),
		  .io({tmpIO_0__en_24_net[0:0]}),
		  .siovref(tmpSIOVREF__en_24_net),
		  .interrupt({tmpINTERRUPT_0__en_24_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__en_24_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__en_5_net;
	wire [0:0] tmpFB_0__en_5_net;
	wire [0:0] tmpIO_0__en_5_net;
	wire [0:0] tmpINTERRUPT_0__en_5_net;
	electrical [0:0] tmpSIOVREF__en_5_net;

	cy_psoc3_pins_v1_10
		#(.id("4ad1332f-dfc4-4a4e-bcbd-76302cc6dd0c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		en_5
		 (.oe(tmpOE__en_5_net),
		  .y({Net_195}),
		  .fb({tmpFB_0__en_5_net[0:0]}),
		  .io({tmpIO_0__en_5_net[0:0]}),
		  .siovref(tmpSIOVREF__en_5_net),
		  .interrupt({tmpINTERRUPT_0__en_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__en_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_112 = ~Net_187;


    assign Net_352 = Net_360 & Net_355;


    assign Net_195 = ~Net_352;


    assign Net_225 = Net_352 ^ Net_187;


    assign Net_245 = Net_225 & Net_266;
	...
	wire [0:0] tmpOE__Interrupt_Out_net;
	wire [0:0] tmpFB_0__Interrupt_Out_net;
	wire [0:0] tmpIO_0__Interrupt_Out_net;
	wire [0:0] tmpINTERRUPT_0__Interrupt_Out_net;
	electrical [0:0] tmpSIOVREF__Interrupt_Out_net;

	cy_psoc3_pins_v1_10
		#(.id("031ee0fd-19b9-436e-9630-06266ea40e6d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Interrupt_Out
		 (.oe(tmpOE__Interrupt_Out_net),
		  .y({Net_245}),
		  .fb({tmpFB_0__Interrupt_Out_net[0:0]}),
		  .io({tmpIO_0__Interrupt_Out_net[0:0]}),
		  .siovref(tmpSIOVREF__Interrupt_Out_net),
		  .interrupt({tmpINTERRUPT_0__Interrupt_Out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Interrupt_Out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
